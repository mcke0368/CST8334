            ...
            <div class="col-sm-2 ">
                ...
                {{ Form::select('rafting-rapid_class',
                    ...
                    isset($activity_log) ? $activity_log->rapid_class : null,
                     ['id' => 'rafting-rapid_class','class' => 'form-control'])
                }}
            </div>
            <div class="col-sm-2 ">
                {{ Form::label('rafting-flow_level', 'Flow Level') }}
                {{ Form::text('rafting-flow_level',
                    isset($activity_log) ? $activity_log->flow_level: null,
                    array('id' => 'rafting-flow_level','class' => 'form-control'))
                }}
            </div>
            <div class="col-sm-2 ">
                {{ Form::label('rafting-launch_site', 'Launch Site') }}
                {{ Form::text('rafting-launch_site',
                    isset($activity_log) ? $activity_log->launch_site : null,
                    array('id' => 'rafting-launch_site','class' => 'form-control'))
                }}
            </div>
            <div class="col-sm-2 ">
                ...
                {{ Form::text('rafting-takeout_site',
                    ...
                    array('id' => 'rafting-takeout_site','class' => 'form-control'))
                }}
            </div>
            <div class="col-sm-2 ">
                ...
                {{ Form::select('rafting-trip_type',
                    ...
                    isset($activity_log) ? $activity_log->trip_type : null,
                    array('id' => 'rafting-trip_type','class' => 'form-control'))
                }}
            </div>            <div class="col-sm-2 ">
                {{ Form::label('rafting-trip_number', 'Trip #') }}
                {{ Form::text('rafting-trip_number',
                    isset($activity_log) ? $activity_log->trip_number : null,
                    array('id' => 'rafting-trip_number','class' => 'form-control'))
                }}
            </div>
        </div>
        ...
        <div class="row"  style="margin-top: 1em">
            <div class="col-sm-12 ">
                <div class="form-group">
                    ...
                    {{ Form::textarea('rafting-notes',
                        isset($activity_log) ? $activity_log->notes: null,
                        array('id' => 'rafting-notes','class' => 'form-control'))
                    }}
                </div>
            </div>
        </div>
