...
<html lang="{{ app()->getLocale() }}">
			...
			<div id="navbar">
				...
				<ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        ...
                        @else
                            <a href="/login" class="btn login-logout btn-danger btn-lg nohover" role="button">Login</a>
                        @endif
                    </li>
				</ul>
			</div>
    ...
    <footer class="navbar-default backgroundRockBlack text-center">
        ...
        <p class="footer-company-name">&copy; Copyright 2018, Adventure Innovation, Inc. All rights reserved.</p>
    </footer>
